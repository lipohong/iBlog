...
class App {
  ...
  constructor() {
    ...
    this.routeConfig();
    this.mongoSetup(globalVars.mongoUrl);
  }
  ...
  private mongoSetup(mongoUrl: string): void {
    ...
    console.log(`start connect to MongoDB, connection is ${mongoUrl} ...`);
    ...
    db.on('disconnected', function () {
      ...
      setTimeout(function () {
        mongoose.connect(mongoUrl, { useNewUrlParser: true, readPreference: ReadPreference.SECONDARY_PREFERRED });
      }, 10000);
    });
    mongoose.connect(mongoUrl, { useNewUrlParser: true, readPreference: ReadPreference.SECONDARY_PREFERRED });
  }
